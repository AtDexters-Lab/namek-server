-- PowerDNS gpgsql schema
-- Ref: https://doc.powerdns.com/authoritative/backends/generic-postgresql.html

\connect powerdns

-- Ensure pdns user can access all tables created in this script
...
CREATE TABLE IF NOT EXISTS tsigkeys (
  ...
  secret                VARCHAR(255),
  CONSTRAINT c_lowercase_name_tsig UNIQUE (name, algorithm)
);
